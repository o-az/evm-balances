...
exports.mapChain = exports.networkUrl = exports.POSSIBLE_CHAIN_NAMES = void 0;
exports.POSSIBLE_CHAIN_NAMES = [
    'polygon',
    'polygon-mainnet',
    'polygon-testnet',
    'polygonTest',
...
const networkUrl = ({ chain, infuraKey, alchemyKey, }) => {
    switch (chain) {
        case 'opera':
        case 'fantom':
        case '250':
...
function mapChain(chain) {
    switch (chain) {
        ...
        case '250':
            return 'fantom';
        default:
            throw new Error(`Unknown chain: "${chain}". Please use one of the following: [ ${exports.POSSIBLE_CHAIN_NAMES.join(', ')} ]`);
    }
}
